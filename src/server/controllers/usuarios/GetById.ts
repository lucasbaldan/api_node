...
import { defaultResponse, IEstado, IUsuario, ResultGet } from "../../entities";
...
export const getById = async (req: Request<{}, {}, IUsuario>, res: Response) => {
        ...
        result = await UsuariosModels.getUsuario(undefined, req.body.id);
